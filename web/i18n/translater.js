...
const defaultEngText = {
  title: 'Download Mailbux application',
...
function getUserLanguage() {
  ...
  try {
    ...
    console.error(`[Mailbux] Error getting user language:`, error);
  }

  console.info(`[Mailbux] Current Language: `, userLanguage);
  return userLanguage;
}
...
async function loadLanguageResources() {
  ...
  try {
    ...
    i18n[language] = data;
    console.info(`[Mailbux] Successfully loaded ${language} resources:`, i18n[language]);
  } catch (error) {
    console.error(`[Mailbux] Error loading ${language} resources:`, error);
    i18n['en'] = defaultEngText;
    console.info(`[Mailbux] Using default English resources:`, i18n['en']);
  }
}
