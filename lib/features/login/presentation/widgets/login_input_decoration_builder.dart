...
class LoginInputDecorationBuilder extends InputDecorationBuilder {
  ...
  InputDecoration build() {
    return InputDecoration(
      ...
      labelStyle: labelStyle ?? const TextStyle(fontFamily: 'Barlow', color: AppColor.textFieldLabelColor, fontSize: 16),
      hintText: hintText,
      hintStyle: hintStyle ?? const TextStyle(fontFamily: 'Barlow', color: AppColor.textFieldHintColor, fontSize: 16),
